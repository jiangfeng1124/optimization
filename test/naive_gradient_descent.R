source("src/naive_gradient_descent.R")
...
results <- NaiveGradientDescent(f1, g1, initial.x, show.trace = FALSE)
...
results <- NaiveGradientDescent(f2, g2, initial.x, show.trace = FALSE)
print(results)
